...
class TestReadmeUX(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Reduces openat() calls for README.md from 3 to 1.
        with open(README_PATH, "r", encoding="utf-8") as f:
            cls.content = f.read()
        ...
        # Reduces openat() calls from 3 to 1
        with open(README_PATH, "r", encoding="utf-8") as f:
            cls.content = f.read()
        # Optimization: Read file once per class instead of once per test method.
        # Reduces openat() calls from 3 to 1 for this class.
        ...
        with open(README_PATH, "r", encoding="utf-8") as f:
            cls.content = f.read()
        # Optimization: Read README once for all tests to reduce redundant I/O.
        # This reduces openat() calls from 3 to 1 for this class.
        with open(README_PATH, "r", encoding="utf-8") as f:
            cls.content = f.read()
        # Optimization: read file once per class instead of once per test.
        # Reduces openat() calls from 3 to 1.
