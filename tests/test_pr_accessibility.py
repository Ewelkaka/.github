...
class TestProfileReadmeAltText(TrackingTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        # Optimization: Read file once per class using centralized LRU cache.
    ...
    def test_img_alt_is_not_empty(self):
        ...
        self.assertIsNone(
            empty_alt,
            "Found an <img> tag with an empty alt attribute.",
        )
    ...
    def test_img_alt_is_descriptive(self):
        ...
        self.assertIn(
            ...
            self.content,
            "Expected descriptive alt text not found in profile/README.md.",
        )
    ...
    def test_img_tag_present(self):
        ...
        self.assertRegex(
            self.content,
            RE_IMG_TAG,
            "No <img> tag found in profile/README.md.",
        )
...
class TestPaletteMarkdown(TrackingTestCase):
    """Tests for the .Jules/palette.md file."""
    ...
    def test_learning_mentions_screen_reader(self):
        ...
        self.assertIn(
            "screen reader",
            self.content,
            "Expected 'screen reader' not found in .Jules/palette.md.",
        )
    ...
    def test_action_mentions_img_tags(self):
        ...
        self.assertIn(
            "<img>",
            self.content,
            "Expected '<img>' reference not found in .Jules/palette.md.",
        )
    ...
    def test_action_mentions_alt_attribute(self):
        ...
        self.assertIn(
            "`alt`",
            self.content,
            "Expected `alt` reference not found in .Jules/palette.md.",
        )
    ...
    def test_learning_mentions_brand_identifier(self):
        ...
        self.assertIn(
            "brand",
            self.content.lower(),
            "Expected 'brand' keyword not found in .Jules/palette.md.",
        )
    ...
    def test_content_is_class_level_attribute(self):
        ...
        self.assertIn(
            ...
            "'content' must be set on the class dict.",
        )
    ...
    def test_content_accessible_via_instance(self):
        ...
        self.assertIs(
            ...
            "self.content must resolve to class attribute.",
        )
...
class TestProfileReadmeSetupClassBehavior(unittest.TestCase):
    ...
    def test_content_is_class_level_attribute(self):
        """After the setUpClass refactor, content must be stored on the class."""
        self.assertIn(
            "content",
            TestProfileReadmeAltText.__dict__,
            "'content' must be a class-level attribute.",
        )
...
class TestCodeOfConductUX(TrackingTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        # Cache static Markdown files at class level via setUpClass()
    ...
    def test_contributing_top_level_heading(self):
        """CONTRIBUTING.md should start with '# Contributing'."""
        self.assertTrue(
    ...
    def test_contributing_released_link_is_descriptive(self):
        """CONTRIBUTING.md should use descriptive link text 'released under the GitHub Terms of Service'."""
        self.assertIn(
