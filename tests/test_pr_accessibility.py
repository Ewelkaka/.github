...
IMG_TAG_FULL_RE = re.compile(r"<img\b[^>]*>", re.IGNORECASE)
...
class TestProfileReadmeAltText(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        # Read the file once for all tests in this class
    ...
    def test_img_tag_present(self):
        ...
        self.assertTrue(
            IMG_TAG_START_RE.search(self.content),
    ...
    def test_all_img_tags_have_nonempty_alt(self):
        ...
        """
        img_tags = IMG_TAG_FULL_RE.findall(self.content)
        for tag in img_tags:
