...
RE_IMG_TAGS_ALL = re.compile(r"<img\b[^>]*>", re.IGNORECASE)
...
class TestProfileReadmeAltText(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Optimization: Pre-calculate img_tags to avoid redundant re.findall calls
        cls.img_tags = RE_IMG_TAGS_ALL.findall(cls.content)
    ...
    def test_all_img_tags_have_nonempty_alt(self):
        ...
        """
        # Optimization: Use pre-calculated img_tags
