...
## 2026-04-03 - Use sequential numbering for ordered lists in documentation
**Learning:** While Markdown supports non-sequential numbering for ordered lists (e.g., all 0s), using sequential numbering (1., 2., 3.) significantly improves human readability and editability of the raw source file, especially for contributors who may not be using a preview-enabled editor.
**Action:** Convert non-sequential ordered list items to sequential ones in documentation files to enhance contributor experience and source code clarity.
